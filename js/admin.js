...
//     // Fetch and display categories
//     function fetchCategories() {
//         fetch('http://172.167.9.47:5000/categories')
//             .then(response => response.json())
//             .then(categories => {
//                 categoryList.innerHTML = '';
//                 productCategorySelect.innerHTML = '<option value="">Select Category</option>';
...
//                     deleteButton.classList.add('btn', 'btn-delete');
//                     deleteButton.addEventListener('click', () => {
//                         fetch(`http://172.167.9.47:5000/deleteCategory/${category.catid}`, {
//                             method: 'DELETE'
//                         }).then(() => {
//                             fetchCategories();
//                         });
...
//                         const newName = prompt('Enter new category name:', category.name);
//                         if (newName) {
//                             fetch(`http://172.167.9.47:5000/updateCategory/${category.catid}`, {
//                                 method: 'PUT',
//                                 headers: {
//                                     'Content-Type': 'application/json'
//                                 },
...
//     // Fetch and display products
//     function fetchProducts(categoryId = '') {
//         let url = 'http://172.167.9.47:5000/products';
//         if (categoryId) {
//             url = `http://172.167.9.47:5000/products/${categoryId}`;
//         }
//         fetch(url)
//             .then(response => response.json())
//             .then(products => {
...
//                     deleteButton.classList.add('btn', 'btn-delete');
//                     deleteButton.addEventListener('click', () => {
//                         fetch(`http://172.167.9.47:5000/deleteProduct/${product.pid}`, {
//                             method: 'DELETE'
//                         }).then(() => {
//                             fetchProducts(categoryId);
//                         });
...
//                         const newDescription = prompt('Enter new product description:', product.description);
//                         if (newName && newPrice && newDescription) {
//                             fetch(`http://172.167.9.47:5000/updateProduct/${product.pid}`, {
//                                 method: 'PUT',
//                                 headers: {
//                                     'Content-Type': 'application/json'
//                                 },
...
//         fetch('http://172.167.9.47:5000/addCategory', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',  // 发送 JSON 格式的数据
//             },
...
//         e.preventDefault();
//         const formData = new FormData(productForm);
//         fetch('http://172.167.9.47:5000/addProduct', {
//             method: 'POST',
//             body: formData
//         }).then(() => {
//             fetchProducts();
